...
/**
*/
class Corelink_audio_receiverAudioProcessor  : public juce::AudioProcessor
...
public:
    //==============================================================================
    Corelink_audio_receiverAudioProcessor();
    ~Corelink_audio_receiverAudioProcessor() override;
...
private:
    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (Corelink_audio_receiverAudioProcessor)
