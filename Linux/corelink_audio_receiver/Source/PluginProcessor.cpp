...
//==============================================================================
Corelink_audio_receiverAudioProcessor::Corelink_audio_receiverAudioProcessor()
...
#endif
{
    ...
    std::thread receiver_thread(&Corelink_audio_receiverAudioProcessor::client_request, this, std::ref(client), std::ref(info), std::ref(control_channel_id));
...
//    std::thread watermarking_thread(&Corelink_audio_receiverAudioProcessor::watermarking, this, std::ref(read_pos), std::ref(write_pos), std::ref(ready));
//    watermarking_thread.detach();
}
//

void Corelink_audio_receiverAudioProcessor::watermarking(std::atomic<int>& read_pos, std::atomic<int>& write_pos, bool& ready)
{
    while(true)
    {
...
void Corelink_audio_receiverAudioProcessor::client_request(corelink::client::corelink_classic_client& client, corelink::client::corelink_client_connection_info& info, corelink::core::network::channel_id_type& control_channel_id)
{
    while (!stream_init);
...
//    info.set_hostname("corelink.hpc.nyu.edu");
  ...
  if(!client.init_protocols())
    ...
    control_channel_id = client.add_control_channel(
                                                    ...
                                                    std::bind(&Corelink_audio_receiverAudioProcessor::on_error, this, std::placeholders::_1, std::placeholders::_2),
                                                    std::bind(&Corelink_audio_receiverAudioProcessor::on_channel_init, this, std::placeholders::_1),
                                                    std::bind(&Corelink_audio_receiverAudioProcessor::on_channel_uninit, this, std::placeholders::_1));
...
void Corelink_audio_receiverAudioProcessor::set_stream_init()
{
    stream_init = true;
}

bool Corelink_audio_receiverAudioProcessor::get_stream_init()
{
    return stream_init;
}

void Corelink_audio_receiverAudioProcessor::set_audio_workspace(const juce::String& val)
{
    audio_workspace = val;
}

juce::String Corelink_audio_receiverAudioProcessor::get_audio_workspace()
{
    return audio_workspace;
}

void Corelink_audio_receiverAudioProcessor::set_audio_stream_type(const juce::String& val)
{
    audio_stream_type = val;
}

juce::String Corelink_audio_receiverAudioProcessor::get_audio_stream_type()
{
    return audio_stream_type;
}

void Corelink_audio_receiverAudioProcessor::set_host_id(const juce::String& val)
{
    corelink_host_id = val;
}

juce::String Corelink_audio_receiverAudioProcessor::get_host_id()
{
    return corelink_host_id;
}

void Corelink_audio_receiverAudioProcessor::set_buffering_size(const juce::String& val)
{
...
int Corelink_audio_receiverAudioProcessor::get_buffering_size()
{
    return buffering_size;
}

void Corelink_audio_receiverAudioProcessor::set_dir_path(const juce::String& val)
{
    dir_path = val.toStdString();
}

std::string Corelink_audio_receiverAudioProcessor::get_dir_path()
{
    return dir_path;
}

void Corelink_audio_receiverAudioProcessor::on_error(corelink::core::network::channel_id_type host_id, in<std::string> err) {
    std::cerr << "Error in host id: " << host_id << "\n" << err << "\n";

    done = true;
}

void Corelink_audio_receiverAudioProcessor::on_channel_init(corelink::core::network::channel_id_type host_id)
{
...
void Corelink_audio_receiverAudioProcessor::on_channel_uninit(corelink::core::network::channel_id_type host_id)
{
...
void Corelink_audio_receiverAudioProcessor::add_on_update_handler(ns_cl_core::network::channel_id_type control_channel_id,
...
void Corelink_audio_receiverAudioProcessor::create_receiver(ns_cl_core::network::channel_id_type control_channel_id,
                     out<corelink::client::corelink_classic_client> client)
{
...
//
//                                    std::async(std::launch::async, &Corelink_audio_receiverAudioProcessor::write_latency, this, millis -  headers.get_int64("start_time"));
...
void Corelink_audio_receiverAudioProcessor::write_latency(long long val)
{
...
template<class T>
void Corelink_audio_receiverAudioProcessor::swapMove(T& a, T& b)
{
    T tmp = { std::move(a) };
    a = std::move(b);
    b = std::move(tmp);
...
//==============================================================================
const juce::String Corelink_audio_receiverAudioProcessor::getName() const
{
    return JucePlugin_Name;
}

bool Corelink_audio_receiverAudioProcessor::acceptsMidi() const
{
...
bool Corelink_audio_receiverAudioProcessor::producesMidi() const
{
...
bool Corelink_audio_receiverAudioProcessor::isMidiEffect() const
{
   #if JucePlugin_IsMidiEffect
    return true;
   #else
...
double Corelink_audio_receiverAudioProcessor::getTailLengthSeconds() const
{
    return 0.0;
}

int Corelink_audio_receiverAudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int Corelink_audio_receiverAudioProcessor::getCurrentProgram()
{
    return 0;
}

void Corelink_audio_receiverAudioProcessor::setCurrentProgram (int index)
{
}

const juce::String Corelink_audio_receiverAudioProcessor::getProgramName (int index)
{
    return {};
}

void Corelink_audio_receiverAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}

//==============================================================================
void Corelink_audio_receiverAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
...
void Corelink_audio_receiverAudioProcessor::releaseResources()
{
...
#ifndef JucePlugin_PreferredChannelConfigurations
bool Corelink_audio_receiverAudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
  #if JucePlugin_IsMidiEffect
...
void Corelink_audio_receiverAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
//    std::chrono::steady_clock::time_point start = std::chrono::steady_clock::now();
...
//                if (dir_path != "")
//                {
//                    std::thread write_to_dat_thread(&Corelink_audio_receiverAudioProcessor::write_to_dat, this, std::move(data_to_write), counter_lst[c_read_counter()], std::ref(dir_path));
...
//                std::async(std::launch::async, &Corelink_audio_receiverAudioProcessor::send_data, this);
...
void Corelink_audio_receiverAudioProcessor::write_to_dat(std::vector<float> data, int counter, std::string& dir_path)
{
...
//==============================================================================
bool Corelink_audio_receiverAudioProcessor::hasEditor() const
{
    return true;
}

juce::AudioProcessorEditor* Corelink_audio_receiverAudioProcessor::createEditor()
{
    return new Corelink_audio_receiverAudioProcessorEditor (*this);
}

//==============================================================================
void Corelink_audio_receiverAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
...
void Corelink_audio_receiverAudioProcessor::setStateInformation (const void* data, int sizeInBytes)
{
...
{
    return new Corelink_audio_receiverAudioProcessor();
}
