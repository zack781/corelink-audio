...
/**
*/
class Corelink_audio_senderAudioProcessor  : public juce::AudioProcessor
...
public:
    //==============================================================================
    Corelink_audio_senderAudioProcessor();
    ~Corelink_audio_senderAudioProcessor() override;
    ...
    void add_on_subscribe_handler(ns_cl_core::network::channel_id_type control_channel_id,
                                                     out<corelink::client::corelink_classic_client> client);
...
private:
    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (Corelink_audio_senderAudioProcessor)
    
    corelink::client::corelink_classic_client client;
    corelink::client::corelink_client_connection_info info = ns_cl_client::corelink_client_connection_info(corelink::core::network::constants::protocols::tcp);
