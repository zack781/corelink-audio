...
/**
*/
class Corelink_audio_senderAudioProcessorEditor  : public juce::AudioProcessorEditor
{
public:
    Corelink_audio_senderAudioProcessorEditor (Corelink_audio_senderAudioProcessor&);
    ~Corelink_audio_senderAudioProcessorEditor() override;
...
private:
    ...
    Corelink_audio_senderAudioProcessor& audioProcessor;
...
//    juce::Component main_component();
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (Corelink_audio_senderAudioProcessorEditor)
};
